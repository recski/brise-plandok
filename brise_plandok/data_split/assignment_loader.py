...
from brise_plandok.data_split.utils.constants import ANNOTATORS, ASSIGNMENT_DF_HEADER, ASSIGNMENT_TXT, ASSIGNMENT_FILE_HEADER
...
def _add_assigment_for_annotator(annotator, folder, docs):
    path = os.path.join(folder, annotator, ASSIGNMENT_TXT)
