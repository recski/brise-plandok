...
def generate_batch(doc_tracking_file, batch_size, json_folder, cycle_nr, annotators_folder, xlsx_folder, generate_xlsx, overwrite, update):
    ...
    genereate_xlsx_files(next_docs, json_folder, xlsx_folder, overwrite)
    distribute_xlsx_files(xlsx_folder, assignment_df, annotators_folder, update)
...
def main():
    ...
    generate_batch(args.dataset_file, args.batch_size, args.json_folder, args.cycle,
                   args.annotators_folder, args.xlsx_folder, args.generate_xlsx, args.overwrite, args.update)
