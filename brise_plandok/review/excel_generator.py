...
class ExcelGenerator:
    ...
    def __fill_attribute(self, attribute_name, attribute_props, review_sheet, base_column, row):
    ...
    def __add_validation_for_row(self, review_sheet, row, data_val, review_val):
        for cell in review_sheet[str(row)]:
            col = cell.column
            if self.__not_attribute(col):
                continue
            self.__add_validation_for_cell(review_sheet, row, col, data_val, review_val)

    def __add_validation_for_cell(self, review_sheet, row, col, data_val, review_val):
